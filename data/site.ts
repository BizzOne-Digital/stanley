...
export const siteConfig = {
  ...
  logo: {
    src: "/brand/conley-delivery-solutions-logo.jpg",
    alt: "Conley Delivery Solutions LLC — Fast, reliable, professional delivery.",
    width: 1024,
    height: 731,
  },
...
export const navigation: NavItem[] = [
  ...
  { label: "Drive With Us", href: "/subcontractors" },
